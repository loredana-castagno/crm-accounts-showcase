...
export default function AccountsSearchInput() {
    ...
    const fetchSuggestions = useCallback(async (term: string) => {
        ...
        try {
            const { searchAccountSuggestions } = await import('@/app/actions/searchSuggestions');
            const results = await searchAccountSuggestions(term);
    ...
    return (
        <div className="relative">
            ...
            <input
                ...
                placeholder="Search by Company Name, Website or any other term. Use AND/OR and parenthesis if needed"
                    ...
                    <div className="max-h-80 overflow-y-auto">
                        {suggestions.map((s, idx) => {
                            ...
                            >
                                ...
                                <span className="text-[9px] font-bold uppercase tracking-wider px-1.5 py-0.5 rounded-full bg-emerald-50 text-emerald-600">
                                    Account
                                </span>
                            </a>
                            );
